...
| `allowManagedHooksOnly`                        | When `true`, restricts which hooks run, and Claude Code also narrows [`statusLine`](/docs/en/statusline), `fileSuggestion`, and `subagentStatusLine` to managed settings. See [Hook configuration](/docs/en/settings#hook-configuration)                                                                                          |
