...
<Tabs>
  <Tab title="Session events">
    ...
    | `session.thread_created`           | New [multiagent thread](/docs/en/managed-agents/multiagent-orchestration) opened, meaning an additional agent called by the coordinator is starting work.                                                                                                                                                                                                             |
