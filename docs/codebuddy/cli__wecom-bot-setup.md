...
![填写基本信息](https://download.codebuddy.cn/web/docs/1142dcef067e3ef8d87b58a22940d87f7c63a724/docs/static/wecom_create_bot_1.D5tSjnJQ.png)

### 1\.3 切换到 API 模式

在页面底部点击「API 模式创建」。

![切换 API 模式](https://download.codebuddy.cn/web/docs/1142dcef067e3ef8d87b58a22940d87f7c63a724/docs/static/wecom_create_bot_2.D6BjqJJ6.png)

### 1\.4 选择长连接方式

在 API 模式创建页面，找到「API 配置」区域，将连接方式选择为「使用长连接」。

![API 模式创建页面](https://download.codebuddy.cn/web/docs/1142dcef067e3ef8d87b58a22940d87f7c63a724/docs/static/wecom_create_bot_3.DRlXQpTS.png)
...
![API 配置 - 获取 Bot ID 和 Secret](https://download.codebuddy.cn/web/docs/1142dcef067e3ef8d87b58a22940d87f7c63a724/docs/static/wecom_create_bot_4.mRGxr9uD.png)
