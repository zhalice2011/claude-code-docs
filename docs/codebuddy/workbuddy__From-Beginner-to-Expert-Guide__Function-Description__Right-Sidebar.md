...
![多标签浏览](/docs/static/browser-multitab.sf_Mas5P.png)
...
![清除浏览数据](/docs/static/browser-clear-data.C69aA4u2.png)

### 设备调试工具栏

内置浏览器顶部提供设备工具栏，可一键切换**手机 / 平板 / 桌面**视口，或自定义宽高，方便验证页面在不同设备下的响应式表现。

![设备调试工具栏](/docs/static/browser-device-toolbar.CW3QxART.png)
