...
![企业后台](https://download.codebuddy.cn/web/docs/b59261153a07e588aebcf9cd16cba1bc45ad81f9/docs/static/login-1.CAoW5mjy.png)在侧边栏打开**登录\-认证源**，在**我的认证源**中将飞书打开即可。若不需要其它认证源则将其关闭，仅保留飞书认证源。
