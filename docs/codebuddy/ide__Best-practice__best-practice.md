...
**步骤一：需求分析与规划**
	...
	- 描述博客需求："我想创建一个个人技术博客，具有文章展示、分类管理和评论功能"![任务描述](https://download.codebuddy.cn/web/docs/b470245b0164accb3ce221fdb91b4fdc621a6b15/docs/static/task.B-aRWj9e.png)
...
- 使用 CloudStudio 或 CloudBase 一键部署
	...
	- 创建待办事项 Web 应用![部署成功](https://download.codebuddy.cn/web/docs/b470245b0164accb3ce221fdb91b4fdc621a6b15/docs/static/todo.BfGm17lb.png)

 \* 将待办事项 Web 应用部署到 CloudStudio ![部署成功](https://download.codebuddy.cn/web/docs/b470245b0164accb3ce221fdb91b4fdc621a6b15/docs/static/deploy.DIWb3RFl.png)

	- 创建待办事项 Web 应用链接![部署成功](https://download.codebuddy.cn/web/docs/b470245b0164accb3ce221fdb91b4fdc621a6b15/docs/static/cloudstudio.BqwYRU1-.png)
- 配置自定义域名和 HTTPS 证书
- 设置 CDN 加速和性能优化
- 获取可访问的在线博客地址

![部署集成](https://download.codebuddy.cn/web/docs/b470245b0164accb3ce221fdb91b4fdc621a6b15/docs/static/cs.X63P7yIc.png)
...
![UI 组件生态](https://download.codebuddy.cn/web/docs/b470245b0164accb3ce221fdb91b4fdc621a6b15/docs/static/ui-ecosystem.BTzv67iU.png)
...
![创建自定义指令](https://download.codebuddy.cn/web/docs/b470245b0164accb3ce221fdb91b4fdc621a6b15/docs/static/project-command.8txhj6uH.png)
...
在 CodeBuddy IDE 中安装 document\-skills 包（适用于非专业开发者）：
	...
	- 下载安装包到本地并双击解压
	- 打开 CodeBuddy IDE，创建本地文件夹![创建本地文件夹](https://download.codebuddy.cn/web/docs/b470245b0164accb3ce221fdb91b4fdc621a6b15/docs/static/ppt-img_1.P1-Z2Z5P.jpg)
	- 进入配置页面，找到 Skill 配置路径（用户 Skill 是全局配置，配置一次在任何文件夹中都可使用）![创建本地文件夹](https://download.codebuddy.cn/web/docs/b470245b0164accb3ce221fdb91b4fdc621a6b15/docs/static/skills.DM5K9kO9.png)
...
![与 CodeBuddy Agent 交互](https://download.codebuddy.cn/web/docs/b470245b0164accb3ce221fdb91b4fdc621a6b15/docs/static/ppt-skill.BPeCrB0i.png)
