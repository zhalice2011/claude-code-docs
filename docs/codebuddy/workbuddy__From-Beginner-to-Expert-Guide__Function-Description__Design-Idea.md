...
设计中难免遇到图片素材不足的情况，你可以指定 WorkBuddy 的处理方式。点击输入框下方的素材处理开关（按钮显示当前选择），即可随时切换：
...
设计创意模式内置多套**设计风格模板**，创建任务时选择模板，即可生成同款风格的画布素材，Web App、海报、PPT、移动 App 等设计类型均可使用。

1. 点击输入框下方的 **设计风格** 选择器，展开模板列表；
2. 默认展示**品牌风格模板**：TDesign、Apple、Meta、Miro、Notion、Spotify、Discord、Linear、X AI、Ferrari 等，选择后 AI 将按对应品牌的视觉风格生成设计稿；
...
未选择模板时，AI 会根据你的描述自动匹配风格；也可以在对话中随时用自然语言指定风格，例如「换成极简风」。
