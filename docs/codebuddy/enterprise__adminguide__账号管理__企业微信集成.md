...
![企业后台](https://download.codebuddy.cn/web/docs/7033ab3f759261b384bb75b91065de873d4a3f44/docs/static/login-1.CAoW5mjy.png)在侧边栏打开**登录\-认证源**，在**我的认证源**中将企微打开即可。若不需要其它认证源则将其关闭，仅保留企微认证源。
